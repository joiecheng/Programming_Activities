    ...
    try:
        if len(b)==3:
            ...
            bcheck=[
                ...
                [b[0][1],b[1][1],b[2][1],b[3][1],b[4][1],[5][1]],
                [b[0][2],b[1][2],b[2][2],b[3][2],b[4][2],[5][2]],
                [b[0][3],b[1][3],b[2][3],b[3][3],b[4][3],[5][3]],
                [b[0][4],b[1][4],b[2][4],b[3][4],b[4][4],[5][4]],
                [b[0][5],b[1][5],b[2][5],b[3][5],b[4][5],[5][5]],
